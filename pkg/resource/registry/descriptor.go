...
const (
	FinalizerString = "finalizers.glue.services.k8s.aws/Registry"
)

var (
	GroupVersionResource = svcapitypes.GroupVersion.WithResource("registries")
