...
// +kubebuilder:rbac:groups=glue.services.k8s.aws,resources=registries,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=glue.services.k8s.aws,resources=registries/status,verbs=get;update;patch

var lateInitializeFieldNames = []string{}

// resourceManager is responsible for providing a consistent way to perform
// CRUD operations in a backend AWS service API for Registry custom resources.
