...
func (r *resource) SetIdentifiers(identifier *ackv1alpha1.AWSIdentifiers) error {
	...
	r.ko.Spec.RegistryName = &identifier.NameOrID
...
func (r *resource) PopulateResourceFromAnnotation(fields map[string]string) error {
	f0, ok := fields["registryName"]
	if !ok {
		return ackerrors.NewTerminalError(fmt.Errorf("required field missing: registryName"))
	}
	r.ko.Spec.RegistryName = &f0
