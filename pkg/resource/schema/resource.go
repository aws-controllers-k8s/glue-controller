...
func (r *resource) SetIdentifiers(identifier *ackv1alpha1.AWSIdentifiers) error {
	...
	r.ko.Spec.SchemaName = &identifier.NameOrID
...
func (r *resource) PopulateResourceFromAnnotation(fields map[string]string) error {
	f0, ok := fields["schemaName"]
	if !ok {
		return ackerrors.NewTerminalError(fmt.Errorf("required field missing: schemaName"))
	}
	r.ko.Spec.SchemaName = &f0
