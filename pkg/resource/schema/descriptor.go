...
const (
	FinalizerString = "finalizers.glue.services.k8s.aws/Schema"
)

var (
	GroupVersionResource = svcapitypes.GroupVersion.WithResource("schemas")
