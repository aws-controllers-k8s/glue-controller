...
const (
	FinalizerString = "finalizers.glue.services.k8s.aws/Database"
)

var (
	GroupVersionResource = svcapitypes.GroupVersion.WithResource("databases")
